...
public class PlayingMovieActivity extends AppCompatActivity implements RetryClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Playing Movies");
    ...
    private void loadFirstPage() {
        ...
        mMovieService.getPlayingLists(currentPage, Common.API_KEY).enqueue(new Callback<MovieList>() {
            @Override
